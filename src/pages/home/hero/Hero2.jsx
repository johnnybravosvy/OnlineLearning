import heImg from "../../../assets/home/photo-1531545514256-b1400bc00f31.jpeg";

const Hero2 = () => {
  return (
    <div
      className="min-h-screen bg-cover"
      style={{ backgroundImage: `url(${heImg})` }}
    >
          ...
          <div className="space-y-4">
            ...
            <div className="md:w-1/2">
              <p>
                ...
                delectus, illum officiis ipsam est deserunt corrupti officia in
                error. Id!
              </p>
            </div>
